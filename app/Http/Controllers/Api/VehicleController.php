...
class VehicleController extends Controller
{
     ...
     */
    public function registerVehicle($register_number)
    {
        $registerNumber = preg_replace('/\s+/', '', $register_number);
        if (!empty($registerNumber) && preg_match('/\b[A-Z]{1,2}\d{4}[A-Z]{2}\b/', $registerNumber)) {
        ...
        return response()->json(['status' => 'error', 'message' => Lang::get('vehicles.incorrect_register_number'), 'data' => ['register_number' => $register_number]], 400);
    }
     ...
     * @return \Illuminate\Http\JsonResponse
     */
    public function signOutVehicle($register_number)
    {
        $registerNumber = preg_replace('/\s+/', '', $register_number);
